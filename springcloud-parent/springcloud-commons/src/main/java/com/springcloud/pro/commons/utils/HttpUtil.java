...
import com.springcloud.pro.commons.config.SysConfig;
...
public class HttpUtil {
    ...
    static{
        Resource resource = new ClassPathResource("cert/apiclient_cert.p12");//获取微信证书 或者直接从文件流读取
        char[] keyStorePassword = SysConfig.getWecatMchid().toCharArray(); //证书密码
        try {
